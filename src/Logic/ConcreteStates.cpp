...
#include "SystemController.h" // ANA CONTROLLER
#include <iostream>

// --- NORMAL STATE ---
void NormalState::enterState(SystemController* context) { std::cout << "[NormalState] Giris yapildi.\n"; }
void NormalState::exitState(SystemController* context) { std::cout << "[NormalState] Cikis yapiliyor.\n"; }
void NormalState::handle(SystemController* context) { std::cout << "Islem: Standart kullanim modu aktif.\n"; }
...
void HighPerformanceState::enterState(SystemController* context) { std::cout << "[HighPerformance] Giris: Fanlar tam gaz!\n"; }
void HighPerformanceState::exitState(SystemController* context) { std::cout << "[HighPerformance] Cikis.\n"; }
void HighPerformanceState::handle(SystemController* context) { std::cout << "Islem: Maksimum guc!\n"; }
...
// --- LOW POWER STATE ---
void LowPowerState::enterState(SystemController* context) { std::cout << "[LowPower] Giris: Isiklar kisildi.\n"; }
void LowPowerState::exitState(SystemController* context) { std::cout << "[LowPower] Cikis.\n"; }
void LowPowerState::handle(SystemController* context) { std::cout << "Islem: Tasarruf modu.\n"; }
...
// --- SLEEP STATE ---
void SleepState::enterState(SystemController* context) { std::cout << "[Sleep] Uyku modu.\n"; }
void SleepState::exitState(SystemController* context) { std::cout << "[Sleep] Uyaniliyor...\n"; }
void SleepState::handle(SystemController* context) { std::cout << "Islem: Sistem uykuda.\n"; }
